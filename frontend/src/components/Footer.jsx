    ...
    <footer style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <a onClick={() => onNavigateToHome && onNavigateToHome()} style={{ color: '#fff', textDecoration: 'none', fontSize: 13, cursor: 'pointer', fontWeight: activeLink === 'home' ? 700 : 500, transition: 'opacity 0.2s', textTransform: 'uppercase' }} onMouseEnter={(e) => e.currentTarget.style.opacity = '0.7'} onMouseLeave={(e) => e.currentTarget.style.opacity = '1'}>Home</a>
