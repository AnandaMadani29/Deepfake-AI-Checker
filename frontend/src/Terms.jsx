      ...
      <header style={{
        ...
        <div style={{
          ...
          <nav style={{ display: 'flex', gap: 30 }}>
            ...
            <Link to="/terms" style={{ color: '#fff', textDecoration: 'none', fontSize: 14, fontWeight: 600 }}>TERMS</Link>
            <Link to="/privacy" style={{ color: '#999', textDecoration: 'none', fontSize: 14 }}>PRIVACY</Link>
          </nav>
        </div>
      </header>
      ...
      <footer style={{
        ...
        <div style={{
          ...
          <nav style={{ display: 'flex', gap: 30 }}>
            ...
            <Link to="/terms" style={{ color: '#fff', textDecoration: 'none', fontSize: 14, fontWeight: 700 }}>TERMS</Link>
            <Link to="/privacy" style={{ color: '#fff', textDecoration: 'none', fontSize: 14 }}>PRIVACY</Link>
          </nav>
        </div>
        <div style={{
          maxWidth: 1200,
