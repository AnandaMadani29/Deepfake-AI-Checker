          ...
          <div style={{ width: "100%", marginTop: 40, padding: isMobile ? "0" : "0 40px" }}>
            <div style={{ maxWidth: isMobile ? 1100 : 1600, margin: "0 auto" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                ...
                <button onClick={clearAll} style={{ background: "transparent", color: "#f87171", border: "1px solid #5b1a2e", padding: "8px 16px", borderRadius: 2, fontSize: 13, fontWeight: 500, cursor: "pointer", transition: "all 0.2s", display: "flex", alignItems: "center", gap: 8 }} onMouseEnter={(e) => { e.currentTarget.style.background = "#2a1120"; e.currentTarget.style.borderColor = "#f87171"; }} onMouseLeave={(e) => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.borderColor = "#5b1a2e"; }}>Clear All<img src="/assets/detection/closeIconRed.png" alt="Clear" style={{ width: 16, height: 16 }} /></button>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {files.map((f, idx) => (
