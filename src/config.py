...
# ════════════════════════════════════════════════════════════
#  ▶ GANTI MODEL DI SINI
MODEL_NAME = "best_resnet50"   # pilihan: efficientnet_b0 | resnet50 | densenet121 | resnet_revised | 2000datasetresnet | resnet1704 | resnet_curated_dataset | new_script_resnet | resnet50_fold4
# ════════════════════════════════════════════════════════════
